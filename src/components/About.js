...
const About = () => {
  return (
    <div
      name='about'
      className='container flex flex-col md:flex-row justify-between items-center mx-auto px-8 md:px-10 lg:px-20 w-full h-screen font-mono text-slate-200 gap-8'>
      <div
        data-aos='fade-up'
